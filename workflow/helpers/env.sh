...
# DATA_ARCHIVE_FOLDER
DATA_ARCHIVE_FOLDER="${PARTS_FOLDER}/data"
/usr/bin/mkdir -p ${DATA_ARCHIVE_FOLDER}
echo "DATA_ARCHIVE_FOLDER=${DATA_ARCHIVE_FOLDER}" >> $GITHUB_ENV

# DATA_ARCHIVE_PREFIX
DATA_ARCHIVE_PREFIX="${PROJECT}-data-"
echo "DATA_ARCHIVE_PREFIX=${DATA_ARCHIVE_PREFIX}" >> $GITHUB_ENV

# DATA_ARCHIVE_SUFFIX
DATA_ARCHIVE_SUFFIX="-${VERSION}.tgz"
echo "DATA_ARCHIVE_PREFIX=${DATA_ARCHIVE_PREFIX}" >> $GITHUB_ENV
